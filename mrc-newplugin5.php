...
?>
  ...
  <td><input type="text" id="mrc_myplugin_option_name" name="mrc_myplugin_option_name" value="<?php echo get_option('mrc_myplugin_option_name'); ?>" /></td>
  </tr>
  </table>
  <?php  submit_button(); ?>
  </form>
...
function mrc_admin_notice__success() {
    ?>
    <div class="notice notice-success is-dismissible">
        <p><?php _e( 'Il plugin è stato attivato! '.get_option('mrc_myplugin_option_name'), 'sample-text-domain' ); ?></p>
    </div>
    <?php
}
add_action( 'admin_notices', 'mrc_admin_notice__success' );
...
add_filter( 'body_class', function( $classes ) {
    return array_merge( $classes, array( get_option('mrc_myplugin_option_name') ) );
} );
